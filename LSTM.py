...
for category in categories:
    ...
    for img in os.listdir(path):
        ...
        img = Image.open(img_path).convert("L")  # Convert images to grayscale for LSTM
        img = img.resize((32, 32))  # Resize image to (32, 32) for LSTM
...
with open('/content/drive/MyDrive/Colab Notebooks/h5files/LSTM_model.json', "w") as json_file:
    json_file.write(model_json)

model.save_weights('/content/drive/MyDrive/Colab Notebooks/h5files/LSTM_model.h5')
